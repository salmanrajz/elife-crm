                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-label-left input_mask" method="post"
                            action="{{route('call-center.store')}}" autocomplete="off">
                            @csrf
                            <!-- Plan name -->
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="name"
                                        placeholder="Type Call Center Name Here" type="text" value="{{ old('name') }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="call_center_short_code"
                                        placeholder="Type Call Center Short Code Here" type="text" value="{{ old('call_center_short_code') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="call_center_amount"
                                        placeholder="Type Call Center Amount" type="number" value="{{ old('call_center_amount') }}">
                                </div>
                            </div>
