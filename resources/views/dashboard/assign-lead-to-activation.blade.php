                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="verification_id" id="verification_id" value="{{$operation->id}}"
                                class="dont_hide">
                            <input type="hidden" name="lead_id" id="leadid" value="{{$operation->id}}"
                                class="dont_hide">
                            ...
                            <div class="container-fluid">
                                <input type="hidden" name="call_back_ajax" class="call_back_ajax" id="call_back_ajax"
                                    value="yes">
                                                ...
                                                data-target="#RejectModalNew1">Re Assing Lead</button>
...
<div id="RejectModalNew" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false" style="margin-top:10%;">
 ...
 <div id="RejectModalNew1" class="modal fade" role="dialog"
                                                ...
                                                !!} --}}
                                                    <form method="POST" id="newpostbaby" enctype="multipart/form-data" class="add-new-post">
                                                <div class="modal-dialog">
                                                    <!-- Modal content-->
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group" style="display:block;"
                                                                        ...
                                                                        <div class="fom-group">
                                                                            ...
                                                                            <select name="assing_to" id="assing_to"
                                                                                ...
                                                                                <option value="{{ $user->id }}"
                                                                                    {{ $user->id == $operation->assign_to ? 'selected' : '' }}>
                                                                                    {{ $user->name }}</option>
                                                                                @endforeach
                                                                ...
                                                                {!! Form::hidden('lead_id', $operation->id) !!}
                                                                {!! Form::hidden('ver_id', $operation->ver_id) !!}
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="button" value="Assign"
                                                                ...
                                                                id="reject_ew" style="display:;" onclick="AssignJunaid('{{route('lead.re-assign')}}','1','newpostbaby')">
                                                        </div>
                                                    </div>
