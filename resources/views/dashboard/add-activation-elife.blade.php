                ...
                <div class="card">
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" onsubmit="return false"
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" item col-md-6 col-sm-6 col-xs-12 form-group ">
                                <label for="activation_screenshot">Sr Photo (Please Upload SR Image)</label>
                                <input class="form-control " id="activation_screenshot" placeholder="Selected Number" data-validate-length-range="6" data-validate-words="2" name="activation_screenshot" type="file">
                            </div>
                            @else
                        ...
                        <div class="form-group">
                            <div class="container-fluid">
                                ...
                                <input type="submit" value="Submit" class="btn btn-success submit_button_new"
                                    onclick="SavingActivationLead('{{route('activate-elife-lead')}}','ActiveForm')">
