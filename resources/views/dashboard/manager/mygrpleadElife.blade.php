                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('AttendLead',['id'=>$id,'channel'=>$channel,'leadid'=>$item->id])}}" data-toggle="tooltip"
                                            ...
                                            {{-- <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                                                data-target="#myModal{{$key}}">Active Lead</button>
                                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
                                                data-target="#RejectLead{{$key}}">Active Lead</button> --}}
                                            @else
