        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                    ...
                                    <select name="simtype" id="simtype" class="sim_type form-control" required>
                                        ...
                                        {{-- <option value="control line" @if (old('simtype')=="control line" )
                                            {{ 'selected' }} @endif>Control Line
                                        </option> --}}
                                        <option value="swyp" @if (old('simtype')=="Swyp" ) {{ 'selected' }} @endif>Swyp
                                        </option>
                                        <option value="pay as u go" @if (old('simtype')=="Pay as u go" )
                                            {{ 'selected' }} @endif>Pay as u go</option>
                                    </select>
                                ...
                                {{-- <div class="col-md-6 col-sm-6 col-xs-12 form-group " id="zone" style="display:none;">
                                    ...
                                    <select name="zone" id="zonetype" class="sim_type form-control" required>
                                        ...
                                        <option value="Defender" @if (old('zone')=="Defender" ) {{ 'selected' }}
                                @endif>
                                Defender</option>
                                <option value="Non Defender" @if (old('zone')=="Non Defender" ) {{ 'selected' }} @endif>
                                    Non Defender</option>
                                <option value="Shared Zone" @if (old('zone')=="Shared Zone" ) {{ 'selected' }} @endif>
                                    Shared Zone</option>
                                </select>
                    ...
                    <option value="Passport" id="" @if (old('emirate_id')=="Passport" ) {{ 'selected' }} @endif>Passport
                    </option>
                    </select>
                ...
                <div class=" item col-md-6 col-sm-6 col-xs-12 form-group">
                    ...
                    <input class="form-control " id="expiry" name="emirate_expiry" placeholder="Etisalat ID Expiry"
                        type="text" value="{{old('emirate_expiry')}}">
                </div>
                <div class=" item col-md-6 col-sm-6 col-xs-12 form-group">
            ...
            @include('dashboard.include.postpaid-new-package')
