            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::model($data,['method'=>'PATCH','action'=>['ItProductsController@update',$data->id]]) !!}
                            @csrf
                            <!-- Plan name -->
                            <div class="form-group">

                                <label for="localminutes" class="control-label col-md-12 col-sm-12 col-xs-12">IT Products
                                    Name</label>
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="name"
                                        placeholder="Type Product Name Here" type="text" value="{{ $data->name }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    ...
                                    <select name="status" id="duration" class="form-control has-feedback-left" required>
