...
<div class="content-body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-container">
                            <form onsubmit="return false" method="post" enctype="multipart/form-data" id="FetchApiForm3">
                                @csrf
                                EID FRONT:
                                <input type="file" name="front_img" id="front_img" onchange="NameApi('{{route('ocr-name.submit')}}','FetchApiForm3')">
                                <h3 class="text-center" id="loading_num1"  style="display:none">
    {{-- Please wait while system loading leads... --}}
    <img src="{{asset('assets/images/loader.gif')}}" alt="Loading" class="img-fluid text-center offset-md-6" style="width:35px;">
</h3>
                        ...
                        <div class="form-container">
                            <form onsubmit="return false" method="post" enctype="multipart/form-data" id="FetchApiForm">
                                @csrf
                                EID BACK:
                                <input type="file" name="front_img" id="front_img" onchange="SavingDataDeal('{{route('ocr.submit')}}','FetchApiForm')">
    ...
    <img src="{{asset('assets/images/loader.gif')}}" alt="Loading" class="img-fluid text-center offset-md-6"  style="width:35px;">
                        ...
                        {{-- <form class="form-horizontal form-label-left input_mask" method="post" action="{{route('activation.store')}}"
                        media> --}}
                        @csrf
                        <!-- Plan name -->
                        <div class="form-group">
                            <input type="hidden" name="verification_id" id="verification_id" value="{{$operation->id}}"
                                class="dont_hide">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                <input class="form-control " id="CustomerNameAct" placeholder="Customer Name" name="cname"
                                    required type="text" value="{{$operation->customer_name}}">
                            </div>
                            <!-- </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" item col-md-6 col-sm-6 col-xs-12 form-group ">
                                <input type="text" name="activation_selected_no" id="activation_selected_no"
                                    ...
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    value="{{$operation->selected_number}}">
                            </div>
                            <!-- <span class="required">*</span> -->
                        ...
                        <div class="form-group row">
                            {{-- <div class=" item col-md-4 col-sm-6 col-xs-12 form-group ">
                                ...
                                <input type="file" name="emirate_id_front" id="emirate_id_front"
                                    placeholder="Emirates ID Front">
                            </div>
                            <div class=" item col-md-4 col-sm-6 col-xs-12 form-group ">
                                <label>Emirates ID Back</label>
                                <input type="file" name="emirate_id_back" id="emirate_id_back"
                                    placeholder="Emirates ID Back">
                            </div>
                            <div class=" item col-md-4 col-sm-6 col-xs-12 form-group ">
                                <label>Activation Screeshot</label>
                                <input type="file" name="activation_screenshot" id="activation_screenshot"
                                    placeholder="Sold BY">
                            </div> --}}
