                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-label-left input_mask" method="post"
                            action="{{route('agency.update',$data->id)}}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @method('PUT')
                            <!-- Plan name -->
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="name"
                                        placeholder="Type Agent Name Here" type="text" value="{{ $data->name }}" autocomplete="off">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                   <select name="location" id="location" class="emirates form-control" >
                                    ...
                                    @foreach($emirates as $emirate)
                                        <option value="{{ $emirate->name }}" @if ($data->location == $emirate->name) {{ 'selected' }} @endif>{{ $emirate->name }}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="agency_id"
                                        placeholder="Agency Code" type="text" value="{{ $data->agency_id }}" autocomplete="off">
                                    {{-- <span class="fa fa-lock form-control-feedback left" aria-hidden="true"></span> --}}
                                </div>
