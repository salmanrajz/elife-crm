                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                    ...
                                    <select name="simtype" id="simtype" class="sim_type form-control" required
                                        ...
                                        {{-- @if ($ptype == 'Prepaid') --}}
                                        <option value="control line" @if (old('simtype')=="control line" ) {{ 'selected' }} @endif>Control Line
                                        </option>
                                        {{-- <option value="swyp" @if (old('simtype')=="Swyp" ) {{ 'selected' }} @endif>Swyp
                                        </option>
                                        <option value="pay as u go" @if (old('simtype')=="Pay as u go" ) {{ 'selected' }}
                                            @endif>Pay as u go</option> --}}
                                        {{-- @endif --}}
                                    </select>
                        ...
                        <div class=" item col-md-6 col-sm-6 col-xs-12 form-group" >
                            ...
                            <input class="form-control " id="dob" name="dob" placeholder="DOB" type="text"
                                value="{{old('dob')}}">
                                                ...
                                                <div class=" item col-md-6 col-sm-6 col-xs-12 form-group" id="amount_control_line" style="display: none;">
