                    ...
                    <div class="card-body">
                        ...
                        <form onsubmit="return false">
                            ...
                            <div class="form-group row">
                                <input class="form-control " id="leadid" value="{{$data->id}}" placeholder="Lead Number"
                                    type="hidden" disabled>
                                <input class="form-control " id="leadno" value="{{$data->lead_no}}"
                                    placeholder="Lead Number" type="text" disabled>
                                <input class="form-control " id="inputSuccess3" name="leadnumber"
                                    value="{{$data->lead_no}}" placeholder="Lead Number" type="hidden">
                            ...
                            <div class="item form-group"> -->
                                ...
                                <div class="  col-md-6 col-sm-12 col-xs-12 form-group ">
                                    ...
                                    <input class="form-control " placeholder="Customer Number i.e 0551234567"
                                        name="cnumber" maxlength="10" required type="text"
                                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        onkeypress="return isNumberKey(event)" id="customer_number"
                                        value="{{$data->customer_number}}" data-mask="999-9999999"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                    ...
                                    <select name="simtype" id="simtype" class="sim_type form-control" required>
                                        ...
                                        <option value="Migration" {{$data->sim_type == 'Migration' ? 'selected' : ''}}>
                                            Migration</option>
                                        @elseif($data->lead_type == 'ITProducts')
                                        @foreach ($itproducts as $itp)
                                        <option value="{{$itp->id}}" {{$data->sim_type == $itp->id ? 'selected' : ''}}>
                                            {{$itp->name}}</option>
                                        @endforeach
                                        @else
                                        <option value="Elife" {{$data->sim_type == 'Elife' ? 'selected' : ''}}>Elife
                                        </option>
                                        @endif
                                    </select>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12 form-group ">
                                    ...
                                    <select name="emirates" id="emirate" class="emirates form-control" required>
                                        ...
                                        <option value="{{ $emirate->name }}"
                                            {{$data->emirates == $emirate->name ? 'selected' : ''}}>{{ $emirate->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class=" item col-md-6 col-sm-12 col-xs-12 form-group ">
                                    ...
                                    <select name="emirate_id" class="form-control " required id="emirate_id">
                                        ...
                                        <option value="Yes, Customer has original Emirates Id" id=""
                                            {{$data->emirate_id == 'Yes, Customer has original Emirates Id' ? 'selected' : ''}}>
                                            Yes, Customer has original Emirates Id</option>
                                        <option value="No" id="" {{$data->emirate_id == 'No' ? 'selected' : ''}}>No
                                        </option>
                                ...
                                <div class=" item col-md-6 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select name="additional_document" class="form-control " id="hideme_document"
                                        ...
                                        <option value="Credit Card" id="" class="hideonelife"
                                            ...
                                            Card</option>
                                        <option value="Pay Slip" id="" class="hideonelife"
                                            {{$data->additional_document == 'Pay Slip' ? 'selected' : ''}}>Pay Slip
                                        </option>
                                        ...
                                        <option value="Car Registration" id="" class="hideonelife"
                                            {{$data->additional_document == 'Car Registration' ? 'selected' : ''}}>Car
                                            Registration</option>
                                        <option value="Labour Contract" id="" class="hideonelife"
                                            {{$data->additional_document == 'Labour Contract' ? 'selected' : ''}}>Labour
                                            Contracts</option>
                                        ...
                                        <option value="Bank Statement 3 Months" id="" class="hideonelife"
                                            {{$data->additional_document == 'Bank Statement 3 Months' ? 'selected' : ''}}>
                                            Bank Statement 3 Months</option>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 form-group ">
                                    ...
                                    <select name="language" class="form-control " required id="language">
                                        ...
                                        <option value="Hindi/Urdu"
                                            {{$data->language == 'Hindi/Urdu' ? 'selected' : ''}}>Hindi / Urdu</option>
                                    </select>
                                </div>
                            ...
                            <div class="item form-group"> -->
                                ...
                                <div class="form-group col-sm-8 col-md-8">
                                    ...
                                    <select name="shared_with" id="shared_with" class="form-control">
                                        ...
                                        <option value="{{ $user->id }}"
                                            {{$data->share_with == $user->id ? 'selected' : ''}}>{{ $user->name }}
                                        </option>
                                        @endforeach
                                ...
                                <div class=" item col-md-5 col-sm-6 col-xs-12 form-group">
                                    ...
                                    <input class="form-control " id="emirate_number" data-mask="999-9999-9999999-9"
                                        ...
                                        placeholder="Emirate ID" type="num" value="{{$data->emirate_num}}">
                                ...
                                <div class=" item col-md-5 col-sm-6 col-xs-12 form-group">
                                    ...
                                    <input class="form-control " id="etisalat_number" data-mask="999-9999999"
                                        ...
                                        placeholder="Etisalat ID" type="num" value="{{$data->etisalat_number}}">

                                </div>
                                @if($data->sim_type == 'Elife')
                                @include('dashboard.include.cord-elife')
                                @elseif($data->sim_type == 'MNP')
                                @include('dashboard.include.cord-mnp')
                                @elseif($data->sim_type == 'New')
                                @include('dashboard.include.cord2-new')
                                @else
                                @include('dashboard.include.cord-itp')
                            ...
                            <div class="container-fluid">
                                ...
                                <audio preload controls src='{{asset('audio')}}/{{$audio->audio_file}}'
                                    id='audio-player' name='audio-player'></audio>
                                @endforeach
                            {{-- </div> --}}
                            {{-- {{auth()->user()->role}} --}}
                            @if (auth()->user()->role == 'Cordination')
                            @php $leadlocation = \App\lead_location::where('lead_id',$data->id)->first() @endphp
                            {{-- <div class="container"> --}}
                            <div class="row">
                                <a href="{{$leadlocation->location_url}}" class="btn btn-success" target="_blank">View
                                    Location URL</a>
                                <a href="https://maps.google.com?q={{$leadlocation->lat}},{{$leadlocation->lng}}"
                            ...
                            {{-- Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur cupiditate distinctio cum sapiente molestiae qui optio ad accusantium reprehenderit modi molestias voluptatem nesciunt nihil quibusdam itaque, quia eaque ullam quas! --}}
                            @else
                            ...
                            <div class="col-sm-4">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group" style="display:block;" id="call_back_at_new">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group ">
                                                        <input type="datetime-local" name="call_back_at_elife"
                                                            class="form-control myDatepicker" id="myDatepicker"
                                                            placeholder="Add Later time"
                                                            aria-describedby="inputSuccess2Status2">
                                                    </div>
                                                    <div class="col-md-7 col-sm-12 col-xs-12 form-group">
                                                        <textarea name="remarks_elife" id="remarks_elife" cols="30"
                                                            rows="10" class="form-control hidden"></textarea>
                                                    </div>
                                                    <input type="submit" value="Follow Up" class="btn btn-success"
                                ...
                                <div id="RejectModalNew" class="modal fade RejectModalNew" role="dialog"
                                    style="margin-top:10%;">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group" style="display:block;" id="Reject_New">
                                                    <select name="reject_comment_new" id="reject_comment"
                                                        class="reject_comment form-control">
                                            ...
                                            <div class="modal-footer">
                                                <input type="submit" value="Reject" class="btn btn-success reject"
