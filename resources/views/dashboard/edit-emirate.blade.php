...
@endif
    ...
    {!! Form::model($data,['method'=>'PATCH','action'=>['EmirateController@update',$data->id]]) !!}
                            {{-- <form class="form-horizontal form-label-left input_mask" method="post" action="{{route('emirate.store')}}"> --}}
@csrf
<!-- Plan name -->
                    <div class="form-group">

                           <label for="localminutes" class="control-label col-md-12 col-sm-12 col-xs-12">Emirate Name</label>
                          <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                            <input class="form-control has-feedback-left" id="inputSuccess3" name="name" placeholder="Type Plan Name Here" type="text" value="{{$data->name}}">
