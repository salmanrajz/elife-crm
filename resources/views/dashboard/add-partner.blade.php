                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="name"
                                        placeholder="Type Partner Name Here" type="text" value="{{ old('name') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    ...
                                    <select name="partner_type" id="duration" class="form-control has-feedback-left">
                                        ...
                                        --}}
                                        {{-- <option value="">--</option> --}}
                                        <option value="Postpaid" @if (old('status')=="Postpaid" ) {{ 'selected' }} @endif>Postpaid
                                        </option>
                                        <option value="Elife" @if (old('status')=="Elife" ) {{ 'selected' }} @endif>Elife
                                        </option>
                                        <option value="ITProducts" @if (old('status')=="ITProducts" ) {{ 'selected' }} @endif>IT Products
                                        </option>
                                    </select>
                                    {{-- <span class="fa fa-lock form-control-feedback left" aria-hidden="true"></span> --}}
                                </div>
