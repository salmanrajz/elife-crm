<div class="package_name new_package" style="display:{{old('simtype') == 'New' ? 'block' : 'block'}}">
    ...
    <select name="mytypeval[]" id="mytypeval" class="form-control" >
        ...
        <div class="col-md-4 col-sm-12 col-xs-12 form-group salman_ahmed">
            <input class="form-control" placeholder="Select Number i.e 0551234567" name="selnumber" maxlength="10"
                required type="text"
                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                onkeypress="return isNumberKey(event)" id="customer_number" value="{{old('cnumber')}}"
        ...
        <div class="col-md-2 col-sm-12 col-xs-12 form-group ">
            <input type="text" name="activation_rate_new" id="activation_rate" class="activation_rate form-control"
                placeholder="I.E 130 AED" value="" onkeypress="return isNumberKey(event)">
        </div>
                    ...
                    <tbody>
                        <tr class="even pointer">
                            ...
                            <td class="a-right a-right m_p ">
                                <input type="text" name="plan_s[]" id="mp1" onchange="myFunction2()" value="0"
                                    class="noborder mp" />
                            </td>
    ...
    <div class="item col-md-12 col-sm-12 col-xs-12 form-group ">
        ...
        <div class="row hidden-lg hidden-ms hidden">
            ...
            <div class="col-sm-12 col-xs-12">
                <div class="form-group">
                    <label for="localminutes" class="control-label col-md-2 col-sm-2 col-xs-12">Preffered Number
                        Allowed</label>
                    <div class="col-sm-12 col-xs-12 form-group ">
            ...
            <div class="col-sm-12 col-xs-12">
                <div class="form-group">
                    <label for="localminutes" class="control-label col-md-2 col-sm-2 col-xs-12">Free Minutes to
                        Preffered</label>
                    <div class="col-sm-12 col-xs-12 form-group ">
    ...
    <div class="form-group">
        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
            <input type="button" value="Submit" class="btn btn-success submit_button_new submit_button_on_no"
                name="upload" id="submit_button" onclick="VerifyLead('{{route('control.submit')}}','elife_form','{{route('home')}}')">
            <input value="Follow Up" class="btn btn-success follow_up_new" data-toggle="modal" data-target="#myModal"
                id="follow_up_new" type="button">
