                                     ...
                                     <table class="table table-striped table-bordered table-responsive">
                                         ...
                                         <tbody>
                                             <tr class="even pointer">
                                                 ...
                                                 <td class="operation ">
                                                     <input type="text" name="plans[]" id="operation" value="{{$plan->operation}}" class="noborder samina" />
                                                 </td>
                                                 <td class="pnum ">
                ...
                //  }
                 ...
                 <div class="item col-md-12 col-sm-12 col-xs-12 form-group ">
                         ...
                         <table class="table table-striped table-bordered table-responsive">
                             ...
                             <tbody>
                                 <tr class="even pointer">
                                     ...
                                     <td class="operation ">
                                         <input type="text" name="plans[]" id="operation" value="" class="noborder samina" />
                                     </td>
                                     <td class="pnum ">
                     ...
                     <div class="row hidden-lg hidden-ms hidden">
                         ...
                         <div class="col-sm-12 col-xs-12">
                             <div class="form-group">
                                 <label for="localminutes" class="control-label col-md-2 col-sm-2 col-xs-12">operation</label>
                                 <div class="col-sm-12 col-xs-12 form-group ">
                     ...
                     <div class="" id="business1" style="display: none;">
                         <table class="table table-striped table-bordered table-responsive">
                             ...
                             <tbody>
                                 ...
                                 <td class=" ">
                                     <select name="devices" id="" class="devices form-control " onchange="getoperation2($(this).val());">
