<div class="package_name itp" style="display:none">
    ...
    <div class="form-group">
        ...
        <textarea name="remarks_itp" id="remarks_itp" cols="30" rows="10" class="remarks_itp form-control">Please Verify</textarea>
    </div>
    <div class="form-group">
