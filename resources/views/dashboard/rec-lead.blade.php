                        ...
                        <form class="form-horizontal form-label-left input_mask" method="post" id="elife_form"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <input type="hidden" name="front_doc_old" value="{{$data->front_document}}">
                                        <input type="hidden" name="back_doc_old" value="{{$data->back_document}}">
                                        <input type="hidden" name="sr_doc_old" value="{{$data->sr_doc}}">
                                        <label for="sr_number_old">Sr Number:</label>
                                        <input type="text" name="sr_number_old" value="{{$data->sr_number}}" readonly class="form-control">
                                ...
                                <div class="item col-md-12 col-sm-12 col-xs-12 form-group ">
                                    ...
                                    <div class="form-group">
                                        <textarea name="remarks" id="remarks_process" cols="30" rows="10"
                                            class="form-control remarks_elife"></textarea>
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                    ...
                                    <input type="button" value="Validate"
                                        class="btn btn-success  submit_mnp submit_button_on_no" name="upload"
                                        id="submit_button"
                                        onclick="VerifyLead('{{route('attach.recording')}}','elife_form','{{route('home')}}')">
                                    <input type="button" value="Non Validate"
                                        class="btn btn-success  submit_mnp submit_button_on_no" name="upload"
                                        id="submit_button"
                                        onclick="VerifyLead('{{route('attach.recording.nonvalidate')}}','elife_form','{{route('home')}}')">
                                    {{-- <input type="button" value="Follow Up"
                                        class="btn btn-success  submit_mnp submit_button_on_no" name="upload"
                                        id="submit_button"
                                        onclick="VerifyLead('{{route('elife.active.submit')}}','elife_form','{{route('home')}}')"> --}}
