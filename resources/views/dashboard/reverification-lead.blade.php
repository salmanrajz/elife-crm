...
@endif
          ...
          <!-- pika booo -->
    {!! Form::model($operation,['method'=>'PATCH','action'=>['VerificationFormController@update',$operation->id],'files'=>true]) !!}
          {{-- <form method="post" id="pre-verification-form"> --}}
            ...
            <div class="table-responsive">
                  ...
                  <div class="col-md-12">
                      <div class="form-group audio_action row" >
                        <div class="col-sm-4 col-xs-12 col-md-4">
                          ...
                          <div class="col-sm-4 col-xs-12 col-md-4">
                            <label for="audio1">Audio 2 <small>Optional</small></label>
                            <input type="file" name="audio[]" id="audio1" class=""  accept="audio/*">

                            </div>
                            <div class="col-sm-4 col-xs-12 col-md-4">
                                <label for="audio1">Audio <small>optional</small></label>
                                <input type="file" name="audio[]" id="audio1" class=""  accept="audio/*">
              ...
              <div class="form-group">
                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                  ...
                  <input type="submit" value="Re Verified" class="btn btn-success" name="upload">
                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Later</button>
            ...
            <!-- my modal reject -->
            <div id="RejectModalNew" class="modal fade" role="dialog">
                      ...
                      <div class="col-md-5 col-sm-5 col-xs-12 form-group">
                        ...
                        <div class="form-group">
                          <div class="input-group date" id="datetimepicker6">
                            <input type="text" class="form-control" name="later_date">
