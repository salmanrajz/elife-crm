            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                {!! Form::model($elife,['method'=>'PATCH','action'=>['ElifePlanController@update',$elife->id]]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="plan_name"
                                        placeholder="Type Plan Name Here" type="text" value="{{$elife->plan_name}}">
                                </div>
                            </div>
                            <!-- Plan name end -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="speed"
                                        placeholder="250 Mbps" type="text" value="{{$elife->speed}}">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="devices"
                                        placeholder="Broadband etc" type="text" value="{{$elife->devices}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <input class="form-control has-feedback-left" id="inputSuccess3"
                                            ...
                                            value="{{$elife->installation_charges}}">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <input class="form-control has-feedback-left" id="inputSuccess3" name="revenue"
                                            placeholder="Revenue" type="number" value="{{$elife->revenue}}">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select name="contract" id="duration" class="form-control has-feedback-left">
                                        ...
                                        <option value="12 Months" @if ($elife->contract == "12 Months") {{ 'selected' }}
                                            @endif>12 Months</option>
                                        <option value="24 Months" @if ($elife->contract == "24 Months") {{ 'selected' }}
                                            @endif>24 Months</option>
                                        <option value="No Contract" @if ($elife->contract == "No Contract")
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <select name="product_type" id="product_type" class="form-control has-feedback-left">
                                        ...
                                        <option value="Elife" @if ($elife->product_type=="Elife" ) {{ 'selected' }}
                                            @endif>Elife</option>
                                        <option value="BitStream" @if ($elife->product_type=="BitStream" ) {{ 'selected' }}
