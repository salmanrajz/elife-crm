                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-label-left input_mask" method="post"
                            action="{{route('admin.user.update',$user->id)}}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <!-- Plan name -->
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="name"
                                        placeholder="Type Agent Name Here" type="text" value="{{ $user->name }}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="inputSuccess3" name="email"
                                        placeholder="Type Email Here" type="email" value="{{ $user->email }}">
                                    {{-- <span class="fa fa-lock form-control-feedback left" aria-hidden="true"></span> --}}
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input type="text" name="rc_code" id="rc_code" class="form-control" value="{{$user->kiosk_id}}">
                        ...
                        <input type="hidden" name="userid" value="{{$user->id}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    ...
                                    <option value="{{$item->call_center_code}}" @if ($user->agent_code == $item->call_center_code) {{ 'selected' }} @endif>{{$item->call_center_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                   <select name="teamleader" id="teamleader" class="form-control" >
                                    ...
                                    @foreach($teamleader as $item)
                                        <option value="{{ $item->id }}" @if ($user->teamleader_id == $item->id) {{ 'selected' }} @endif>{{ $item->name }}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <select name="role" id="role" class="form-control select2">
                                        @foreach ($role as $r)
                                    <option value="{{$r->name}}" @if ($user->role == $r->name) {{ 'selected' }} @endif>{{$r->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                   <select name="emirates" id="emirate" class="emirates form-control" >
                                    ...
                                    @foreach($emirates as $emirate)
                                        <option value="{{ $emirate->name }}" @if ($user->emirate == $emirate->name) {{ 'selected' }} @endif>{{ $emirate->name }}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img id="myImg" src="{{asset('img/').'/'.$user->profile}}" alt="your image" style="width:25%"/>
                            </div>
