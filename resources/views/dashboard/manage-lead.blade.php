                            ...
                            <div class="item form-group"> -->
                                ...
                                <div class="  col-md-4 col-sm-12 col-xs-12 form-group ">
                                    ...
                                    <input class="form-control " placeholder="Customer Number i.e 1234567"
                                        ...
                                        value="{{$z['1']}}" data-mask="9999999" data-validate-length-range="6"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group ">
                                    ...
                                    <select name="simtype" id="simtype" class="sim_type form-control" required
                                        ...
                                        @if ($ptype == 'Postpaid')
                                        <option value="New" @if ($data->product_type=="New" ) {{ 'selected' }} @endif>New
                                        </option>
                                        <option value="MNP" @if ($data->product_type=="MNP" ) {{ 'selected' }} @endif>MNP
                                        </option>
                                        <option value="Migration" @if ($data->product_type=="Migration" ) {{ 'selected' }}
                                            @endif>Migration</option>
                                        @elseif($ptype == 'ITProducts')
                                        @foreach ($itproducts as $itp)
                                        <option value="{{$itp->id}}" @if ($data->product_type==$itp->id) {{ 'selected' }}
                                            @endif>{{$itp->name}}</option>
                                        @endforeach
                                        @else
                                        <option value="Elife" @if ($data->product_type=="Elife" ) {{ 'selected' }} @endif>
                                            Elife</option>
                                        <option value="BitStream" @if ($data->product_type=="BitStream" ) {{ 'selected' }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="pac-input" class="controls form-control" type="text"
                                            placeholder="Enter a location" name="location" value="{{$data->location_name}}">
                                ...
                                {{-- <div class="form-group"> --}}
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <input type="button" value="Submit"
                                            ...
                                            id="submit_button" onclick="VerifyLead('{{route('elife.assigned.submit')}}','elife_form','{{route('home')}}')">
