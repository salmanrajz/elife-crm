...
class Kernel extends HttpKernel
{
    ...
    //     //     DB::table('numberdetails')->delete();
    //     // })->everyMinute();
    //     // $schedule->exec("php artisan your:command");

    //     // $schedule->command('daily_digest:name')->everyFiveMinutes()->withoutOverlapping();
    //     // $schedule->command('daily_digest:send')->everyFiveMinutes()->withoutOverlapping();
    //     // $schedule->command(\App\ConsoleCommands\SendDailyDigest::class)->everyFiveMinutes()->withoutOverlapping();
